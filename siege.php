          ...
          <div id="sort">
            ...
            <?php
                ...
                echo "<table class='lbresult' id='killresults'>
                  <th>Rank</th><th>Player</th><th>Kills &darr;</th><th>Deaths</th><th>Teamkills</th>";
                $query = "SELECT * FROM SGSERVER ORDER BY KILLS DESC LIMIT 50";
                ...
                echo "<table class='lbresult' id='deathresults'>
                  <th>Rank</th><th>Player</th><th>Kills</th><th>Deaths &darr;</th><th>Teamkills</th>";
                $query = "SELECT * FROM SGSERVER ORDER BY DEATHS DESC LIMIT 50";
                $result = mysqli_query($connect, $query);
                $i = 1;
                while($row = mysqli_fetch_array($result)) {
                    echo "<tr>
                ...
                echo "<table class='lbresult' id='tkresults'>
                  <th>Rank</th><th>Player</th><th>Kills</th><th>Deaths</th><th>Teamkills &darr;</th>";
                $query = "SELECT * FROM SGSERVER ORDER BY TKS DESC LIMIT 50";
                $result = mysqli_query($connect, $query);
                $i = 1;
                while($row = mysqli_fetch_array($result)) {
                    echo "<tr>
