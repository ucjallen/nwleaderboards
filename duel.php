      ...
      <section id="boards" class="clear">
          <div id="sort">
            ...
            <?php
                ...
                $query = "SELECT * FROM DLSERVER ORDER BY KILLS DESC LIMIT 50";
                ...
                $query = "SELECT * FROM DLSERVER ORDER BY DEATHS DESC LIMIT 50";
                $result = mysqli_query($connect, $query);
                $i = 1;
                while($row = mysqli_fetch_array($result)) {
                    echo "<tr>
                ...
                $query = "SELECT * FROM DLSERVER ORDER BY TKS DESC LIMIT 50";
                $result = mysqli_query($connect, $query);
                $i = 1;
                while($row = mysqli_fetch_array($result)) {
                    echo "<tr>
